...
public class PessoaHome {
	...
	public Pessoa merge(Pessoa detachedInstance) {
		...
		try {
			Pessoa result = (Pessoa) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Pessoa findById(int id) {
		...
		try {
			Pessoa instance = (Pessoa) sessionFactory.getCurrentSession().get("model.Pessoa", id);
			if (instance == null) {
	...
	public List<Pessoa> findByExample(Pessoa instance) {
		...
		try {
			List<Pessoa> results = (List<Pessoa>) sessionFactory.getCurrentSession().createCriteria("model.Pessoa")
